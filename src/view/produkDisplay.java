...
public class produkDisplay extends javax.swing.JDialog {
    ...
    private void produkDisplayBackButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                        
    ...
    private void produkDisplayAmountStateChanged(javax.swing.event.ChangeEvent evt) {                                                 
        int itemCount = (int) produkDisplayAmount.getValue();
        if(itemCount < 0) {
    ...
    private void produkDisplayPurchaseButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                            
